...
namespace MoneySummary
{
    public class CategoryKeys
    {
        ...
        static public List<CategoryKeys> InitKeys()
        {
            return
            [
                new(Category.OPLATY_STALE, new() { "Spłata kredytu", "OPŁATA EKSPLOATACYJNA", "SKŁADKA ZA UBEZPIECZENIE", "TELEFON", "ebok.gkpge" }),
                ...
                new(Category.ZAKUPY_INTERNETOWE, new() { "allegro", "Allegro" }),
                ...
                new(Category.LEKARZ, new() { "ZIKO", "gemini.pl", "receptomat", "SAME DOBRE APTEKI ESKUL", "APTEKA", "phdoctorlab" }),
